...
class Ui_MainWindow(object):
    ...
    def input_browse(self):
        ...
        self.video_length = video.get(cv2.CAP_PROP_POS_MSEC)/1000.0
        self.end_time_input.setMaximum(self.video_length)
        self.end_time_input.setValue(self.video_length)
